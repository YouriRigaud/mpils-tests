...
RESULTS_ROOT="${RESULTS_ROOT:-/scratch/${USER}/mpils-results-grid-${SOLVER_TIME_MODE}-${SOLVER_TIME}-expl-budget}"
...
OUTPUT_ROOT="${RESULTS_ROOT}/${BATCH_NAME}/${EXPL_BUDGET_FACT}-expl-factor/seed-${SEED}"
...
run_args=(
  ...
  --seed "$SEED"
  --exploration-budget-factor "$EXPL_BUDGET_FACT"
)
